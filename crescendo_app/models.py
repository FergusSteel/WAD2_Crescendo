...
class UserProfile(models.Model):
    ...
    numberOfComments = models.IntegerField(default=0)
    numberOfProfileViews = models.IntegerField(default=0)
    image = models.ImageField(upload_to=(STATIC_DIR + "/profile_images")[1:],
                              default=(STATIC_DIR + '/profile_images/image.jpg')[1:])
...
class Playlist(models.Model):
    ...
    image = models.ImageField(upload_to=(STATIC_DIR + "/playlist_images")[1:],
                              default=(STATIC_DIR + "/playlist_images/image.jpg")[1:])
