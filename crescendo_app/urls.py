...
urlpatterns = [
                  ...
                  path('playlist/<slug:playlist_slug>_<playlist_id>/', views.show_playlist, name='show_playlist'),
                  ...
                  path('song/<slug:song_slug>_<song_id>/', views.show_song, name='show_song'),
